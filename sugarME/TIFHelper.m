...
{
    DDXMLNode* child=[TIFHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[TIFHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[TIFHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
