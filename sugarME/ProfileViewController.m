...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 3)
    {
        _pickerTextField1 = [[UITextField alloc] initWithFrame:CGRectMake(120,10, 280, 30)];
        _pickerTextField1.textAlignment=UITextAlignmentLeft;
        cell.textLabel.text = [profileTitles objectAtIndex:indexPath.row];
        _pickerView1 = [[UIPickerView alloc] init];
        _pickerView1.tag=1000;
    ...
    if (indexPath.row == 4)
    {
        _dateTextField = [[UITextField alloc] initWithFrame:CGRectMake(120, 10, 280, 30)];
    ...
    if (indexPath.row == 5)
    {
        _pickerTextField2 = [[UITextField alloc] initWithFrame:CGRectMake(120,10, 280, 30)];
    ...
    if (indexPath.row == 6)
    {
        _pickerTextField3 = [[UITextField alloc] initWithFrame:CGRectMake(120,10, 280, 30)];
    ...
    if (indexPath.row == 7)
    {
        _pickerTextField4 = [[UITextField alloc] initWithFrame:CGRectMake(120,10, 280, 30)];
    ...
    if (indexPath.row == 8)
    {
        _pickerTextField5 = [[UITextField alloc] initWithFrame:CGRectMake(120,10, 280, 30)];
...
-(void) inputAccessoryViewDidFinish {
    ...
    _pickerTextField2.text=[sizeData objectAtIndex:[_pickerView2 selectedRowInComponent:0]];
    _pickerTextField3.text=[weightData objectAtIndex:[_pickerView3 selectedRowInComponent:0]];
